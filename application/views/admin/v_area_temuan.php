...
<style>
  ...
  <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="<?= base_url('admin/area_temuan'); ?>">Area Temuan</a></li>
            </ol>
          </div>
        </div>
      </div>
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="mb-2">
          <button class="btn btn-primary mr-2 mb-2" data-toggle="modal" data-target="#eop"><i class="fa fa-lock"></i> End Of Periode (EOP)</button>
        </div>
  
        <h5 class="mb-2">Pilih Area Temuan</h5>
        <div class="row">

        <?php foreach($area_temuan as $row): ?>
          <div class="col-md-3 col-sm-6 col-12">
            <div class="info-box">
              <span class="info-box-icon bg-info"><i class="far fa-copy"></i></span>
              <a class="bg_mt" id="tb_form_mt" href="<?= base_url() ?>admin/data_temuan/<?= $row->kode_area ?>">
                <div id="dept-widget" class="info-box-content">
                  <span class="info-box-text"><?= $row->kode_area ?></span>
                  <span class="info-box-number"><?= $row->kode_bagian ?></span>
                </div>
              </a>
            </div>
          </div>
  ...
  <!-- Modal EOP -->
  <div class="modal fade bd-example-modal-lg" id="eop" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">End of Periode (EOP)</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <form action="<?= base_url(); ?>admin/eop" method="post">
          ...
          <div class="modal-footer">
            <button type="submit" class="btn btn-primary" onclick="return confirm('Apakah anda yakin proses EOP?')"><i class="fa fa-procedures"></i> Proses</button>
