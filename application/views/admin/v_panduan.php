    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?= base_url(); ?>admin/panduan" class="nav-link active">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="<?= base_url('admin/panduan'); ?>">Panduan</a></li>
            </ol>
          </div>
        </div>
      </div>
        ...
        <div class="row">
          <div class="col-sm-12">
            ...
            <div class="card">
              ...
              <iframe src="<?= base_url() ?>/public/file/user_guides_sik_admin_v1.pdf#toolbar=0" width="100%" height="700px"></iframe>
