    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?= base_url(); ?>inspektor/area_inspeksi" class="nav-link active">
              <i class="nav-icon fas fa-th"></i>
              <p>
                Data Inspeksi
              </p>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="<?= base_url('inspektor/area_temuan'); ?>">Inspeksi</a></li>
            </ol>
          </div>
        </div>
      </div>
                  ...
                  <?php $no=1; foreach($inspeksi as $row): ?>
                    <tr>
                      ...
                      <td class="text-center">
                        <a href="<?= base_url(); ?>inspektor/hapus_inspeksi/<?= $row->id ?>" class="btn btn-sm btn-danger" data-tooltip="Hapus Temuan" onclick="return confirm('Apakah anda yakin hapus data inspeksi ini?')"><i class="fa fa-trash"></i></a>
                      </td>
                    </tr>
                  <?php endforeach; ?>
...
<script>
  ...
  $(document).on("click", "#img-temuan", function () {
    ...
    $.ajax({
      type: 'POST',
      url: base_url + "inspektor/get_img_inspeksi",
      data: {data: idImg},
      cache: false,
