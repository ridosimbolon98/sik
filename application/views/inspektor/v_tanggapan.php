    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?= base_url(); ?>inspektor/tanggapan" class="nav-link active">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="<?= base_url('inspektor/tanggapan'); ?>">Tanggapan</a></li>
          ...
          <div class="col-sm-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Tanggapan Temuan Inspeksi</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                  ...
                  <?php $no=1; foreach($temuan_inspeksi as $row): ?>
                    <tr>
                      ...
                      <td class="text-center">
                        <button id="btn_tanggapan" class="btn btn-sm btn-info mb-1" data-toggle="modal" data-target="#ubah-tanggapan" data-id="<?= $row->id ?>" data-tanggapan="<?= $row->tanggapan ?>" data-tooltip="Tambah Tanggapan"><i class="fa fa-pen-square"></i> Ubah</button>
                        <a href="<?= base_url() ?>inspektor/close_temuan/<?= $kd_area ?>/<?= $row->id ?>" class="btn btn-sm btn-success mb-1" data-tooltip="Close temuan" onclick="return confirm('Apakah anda yakin close temuan inspeksi ini?')"><i class="fa fa-check-square"></i> Close</a>
                      </td>
                    </tr>
                  <?php endforeach; ?>
        ...
        <form action="<?= base_url(); ?>inspektor/ubah_tanggapan" method="post">
          <div class="modal-body">
            <div class="form-group">
              ...
              <input type="hidden" name="id_tem" id="id_tem" required>
              <input type="hidden" name="kd_area" value="<?= $kd_area ?>" required>
